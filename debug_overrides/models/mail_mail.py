    ...
    def send(self, auto_commit=False, raise_exception=False):
        ...
        for server_id, batch_ids in self._split_by_server():
            ...
            try:
                ...
                _logger.warning(f'MASSMAILING_DEBUG: Sent batch {len(batch_ids)} emails')
                _logger.info(
    ...
    def _send(self, auto_commit=False, raise_exception=False, smtp_session=None):
        ...
        for mail_id in self.ids:
            ...
            try:
                ...
                state_count[mail.state] = state_count.get(mail.state, 0) + 1
                ...
                if mail.headers:
                    try:
                        ...
                        _logger.exception("Couldn't parse headers!")
                        pass
                ...
                if notifs:
                    _logger.warning('MASSMAILING_DEBUG: Concurrent update!')
            ...
            if auto_commit is True:
                self._cr.commit()
        _logger.warning(f'MASSMAILING_DEBUG: States encountered: {state_count}')
        return True
